    ...
    <section className="bg-white p-6 rounded-3xl shadow-sm border border-elche-gray/50">
      ...
      {loading ? (
        ...
        <div className="grid gap-8">
          {/* Product Table */}
          <div className="overflow-hidden rounded-2xl border border-elche-gray/50">
            <table className="w-full border-collapse">
              <thead>
                <tr className="bg-elche-gray/20 text-elche-text-light text-xs font-bold uppercase tracking-wider">
                  ...
                  <th className="text-center p-4">Umbral</th>
              ...
              <tbody className="divide-y divide-elche-gray/30">
                {eventProducts.map(row => (
                  <tr key={row.id} className="hover:bg-elche-gray/5 transition-colors group">
                    <td className="p-4 font-bold text-elche-text">
                      {row.name}
                    </td>
                    ...
                    <td className="p-4 text-center">
                      <input
                        ...
                        className="p-2 rounded-xl w-20 border border-elche-gray/50 text-center font-bold focus:ring-2 focus:ring-elche-primary focus:outline-none"
                      />
                    </td>
                    <td className="p-4 text-center">
                      <input
