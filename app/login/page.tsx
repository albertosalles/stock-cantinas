      ...
      <div className="w-full max-w-[500px]">
        ...
        <div className="text-center mb-8 animate-in fade-in slide-in-from-top-8 duration-500">
          <div className="w-20 h-20 bg-gradient-to-br from-elche-primary to-elche-secondary rounded-3xl mx-auto mb-4 flex items-center justify-center shadow-xl shadow-elche-primary/20 transform rotate-3 hover:rotate-0 transition-transform duration-300">
            <span className="text-4xl drop-shadow-sm">{mode === 'cantina' ? '🏪' : '🔧'}</span>
          </div>
          ...
          <p className="text-elche-text-light font-medium text-sm bg-white/50 px-3 py-1 rounded-full inline-block backdrop-blur-sm">
            {mode === 'cantina' ? 'Sistema de gestión — Elche CF' : 'Acceso Administración'}
          </p>
        </div>
        ...
        {mode === 'cantina' ? (
          ...
          <div className="bg-white rounded-[32px] p-6 md:p-8 shadow-[0_8px_40px_rgba(0,150,79,0.08)] border border-elche-border/60 relative overflow-hidden backdrop-blur-xl">
            ...
            <div className="absolute top-0 left-0 h-1.5 bg-elche-primary w-full" />

            <div className="text-center mb-6">
              <h2 className="text-lg font-bold text-elche-text">Panel de Administración</h2>
              <p className="text-sm text-elche-text-light mt-1">Introduce la contraseña de administrador</p>
            </div>
            ...
            <div className="space-y-4">
              <input
                ...
                className="w-full p-4 rounded-2xl border border-elche-gray bg-elche-bg text-elche-text font-bold text-center text-lg focus:ring-2 focus:ring-elche-primary focus:outline-none focus:border-elche-primary transition-all placeholder:text-elche-text-light/40 placeholder:font-medium"
                autoFocus
              />
              ...
              <button
                ...
                className="w-full py-4 rounded-2xl bg-gradient-to-r from-elche-primary to-elche-secondary text-white font-bold text-lg shadow-lg shadow-elche-primary/20 hover:shadow-xl hover:shadow-elche-primary/30 active:scale-[0.98] transition-all disabled:opacity-50 disabled:cursor-not-allowed"
              >
        ...
        {/* Footer */}
        <div className="mt-8 text-center animate-in fade-in delay-300 duration-500 flex flex-col items-center gap-3">
          {mode === 'cantina' && (
            <button
              onClick={() => { setMode('admin'); setAdminError(''); }}
              className="text-xs text-elche-text-light/60 font-semibold bg-white/40 py-2.5 px-5 rounded-2xl backdrop-blur-md border border-white/50 shadow-sm hover:bg-white/70 hover:text-elche-primary transition-all"
            >
